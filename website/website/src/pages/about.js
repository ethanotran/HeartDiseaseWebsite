...
export default function About() {
  return(
    <body className="page1">
      <NavBar/>
      <h1 className="header-box-info">About Us</h1>
      <p className="information">Alex Tran is a computer science student at the University of Florida, and has worked part time as a web developer at a small company focused on marine life conservation. 
